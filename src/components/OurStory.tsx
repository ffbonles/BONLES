...
import { ArrowRight, Compass, Sparkles, Flame, Check, UtensilsCrossed, PackageCheck } from 'lucide-react';
...
export const OurStory: React.FC<OurStoryProps> = ({ onExploreCatalog }) => {
  ...
  const ourStoryTitle = settings['OUR_STORY_TITLE'] || 'Dari Borneo, Lahir Sebuah Rasa.';
  const ourStoryQuote = settings['OUR_STORY_QUOTE'] || 'Kekayaan daerah bukan hanya untuk dikenang—tetapi bisa dikembangkan, dinikmati, dan dibawa lebih jauh melalui sebuah rasa.';
  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-end">
          <div className="lg:col-span-8 space-y-6">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif text-[#FFFDF9] font-normal tracking-tight leading-[1.12]">
              {ourStoryTitle.includes(',') ? (
                <>
                  {ourStoryTitle.split(',')[0]}, <br className="hidden sm:inline" />
                  <span className="italic font-serif text-[#F5A623] font-normal">
                    {ourStoryTitle.split(',').slice(1).join(',')}
                  </span>
                </>
              ) : (
                <span className="italic font-serif text-[#F5A623] font-normal">{ourStoryTitle}</span>
              )}
            </h2>

            <p className="text-base sm:text-lg text-[#DCD1C0] font-light max-w-2xl leading-relaxed">
              Kekayaan pangan lokal, kreativitas inovatif, dan cerita dedikasi yang kami bawa lebih jauh dalam kemasan standing pouch higienis.
            </p>
          </div>
          ...
          <div className="lg:col-span-4 flex flex-col justify-end space-y-4">
            <p className="text-xs sm:text-sm text-[#A89886] leading-relaxed font-light border-l-2 border-[#D82824] pl-4">
              Menghubungkan hasil tangkapan nelayan dan perkebunan berkualitas dengan seni pengolahan modern bercita rasa luhur.
            </p>
            <div className="pt-2">
              <a
                href="#story-part-01"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 space-y-24 sm:space-y-32">
        ...
        {/* ----------------------------------------------------------------------- */}
        {/* PART 02: THE PACKAGING & HIGH PROTEIN INNOVATION                        */}
        {/* ----------------------------------------------------------------------- */}
        <article id="story-part-02" className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-14 items-center">
          <div className="lg:col-span-7">
            <div className="relative rounded-sm overflow-hidden bg-[#240A0E] border border-[#D82824]/30 shadow-xl group">
              <img
                ...
                alt="Inovasi snack kemasan standing pouch zipper Bonles Food"
                referrerPolicy="no-referrer"
                loading="lazy"
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-[#160608]/90 backdrop-blur-md p-3.5 border border-[#D82824]/30 rounded-xs flex items-center justify-between">
                <div>
                  <span className="text-[9px] uppercase tracking-widest text-[#00D222] font-bold block">
                    Kemasan Standing Pouch Zipper
                  </span>
                  <p className="text-xs text-[#FFFDF9] font-medium">Aluminium Foil Kedap Udara • Tetap Renyah Higienis</p>
                </div>
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-[#FFFDF9] font-normal leading-snug">
              Inovasi Kemasan Pouch <br />
              <span className="italic text-[#F5A623]">&amp; Nutrisi Tinggi Protein</span>
            </h3>

            <p className="text-sm sm:text-base text-[#DCD1C0] leading-relaxed font-light">
              &ldquo;Kami memadukan bahan pangan bernutrisi seperti ikan laut segar dan kedelai berkualitas ke dalam bentuk snack renyah kemasan standing pouch zipper yang praktis, higienis, dan tahan lama tanpa pengawet berlebih.&rdquo;
            </p>

            <p className="text-sm sm:text-base text-[#FFF1D6] leading-relaxed font-normal border-l-2 border-[#D82824] pl-3">
              &ldquo;Dari Amplang Tenggiri super renyah hingga stik ikan gurih dan keripik tempe oven, setiap kemasan pouch dirancang agar pas dinikmati di rumah maupun saat bepergian.&rdquo;
            </p>
          </div>
        </article>

        {/* ----------------------------------------------------------------------- */}
        {/* PART 03: THE BORNEO FLAVOR & SAMBAL DAYAK                               */}
        {/* ----------------------------------------------------------------------- */}
        <article id="story-part-03" className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-14 items-center">
          <div className="lg:col-span-5 order-2 lg:order-1 space-y-5">
            ...
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-[#FFFDF9] font-normal leading-snug">
              Sentuhan Rasa Rempah <br />
              <span className="italic text-[#E53935]">Khas Borneo</span>
            </h3>

            <p className="text-sm sm:text-base text-[#DCD1C0] leading-relaxed font-light">
              &ldquo;Untuk memberikan pengalaman kuliner autentik, kami juga menghadirkan varian Sambal Bawang Dayak sachet cocolan siap santap.&rdquo;
            </p>
            ...
            <div className="p-4 rounded-sm bg-[#240A0E] border border-[#D82824]/30 space-y-3">
              <div className="flex items-center gap-2 text-xs font-semibold text-[#FFFDF9]">
                ...
                <span>Snack Pouch Renyah + Sachet Sambal Bawang Dayak</span>
              </div>
              ...
              <p className="text-xs text-[#B5A898] leading-relaxed font-light">
                Sambal dikemas dalam sachet higienis siap saji sehingga Anda dapat menikmati perpaduan gurih-renyah snack pouch dengan sensasi pedas aromatik khas rempah Kalimantan kapan pun diinginkan.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <div className="relative rounded-sm overflow-hidden bg-[#240A0E] border border-[#D82824]/30 shadow-xl group">
              <img
                ...
                alt="Snack kemasan dengan cocolan Sambal Bawang Dayak sachet"
                referrerPolicy="no-referrer"
                loading="lazy"
                className="w-full h-72 sm:h-96 object-cover object-center group-hover:scale-105 transition-transform duration-700"
              />
        ...
        <article id="story-part-04" className="border-t border-[#D82824]/20 pt-16 sm:pt-20">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-base sm:text-xl text-[#FFF1D6] font-serif italic leading-relaxed max-w-3xl mx-auto">
              &ldquo;Bagi kami, produk ini bukan sekadar camilan. Ini adalah cerita tentang bagaimana kekayaan alam Borneo dan bahan baku lokal dapat diberi sentuhan kreativitas, menjadi produk bernilai tambah tinggi dalam kemasan pouch higienis.&rdquo;
            </p>
            ...
            <div className="pt-8">
              <div className="p-5 sm:p-6 rounded-sm bg-[#240A0E] border border-[#D82824]/30 max-w-3xl mx-auto shadow-lg">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 text-xs sm:text-sm font-sans font-medium text-[#F5EFE6]">
                  <span className="px-3 py-1.5 rounded-xs bg-[#160608] border border-[#D82824]/20">Alam Borneo</span>
                  <span className="text-[#D82824]">→</span>
                  <span className="px-3 py-1.5 rounded-xs bg-[#160608] border border-[#D82824]/20">Pangan Segar Pilihan</span>
                  <span className="text-[#D82824]">→</span>
                  <span className="px-3 py-1.5 rounded-xs bg-[#160608] border border-[#D82824]/20">Tinggi Protein</span>
                  <span className="text-[#D82824]">→</span>
                  <span className="px-3 py-1.5 rounded-xs bg-[#160608] border border-[#D82824]/20">Kemasan Standing Pouch</span>
                  <span className="text-[#D82824]">→</span>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-8">
          ...
          <div className="pt-2">
            ...
            <p className="text-[11px] text-[#A89886] tracking-widest mt-1">
              AUTHENTIC BORNEO • MODERN CRAFT • PREMIUM POUCH SNACK
            </p>
          </div>
        </div>
      </div>
